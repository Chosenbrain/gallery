        ...
        n.extend(h.prototype, {
                init: function() {
                    ...
                    n.fancybox.getInstance() ||
                        l.hideScrollbar === !1 ||
                        (n("body").addClass("fancybox-active"), !n.fancybox.isMobile &&
                ...
                jumpTo: function(t, e) {
                    ...
                    if (!(u.isDragging || u.isClosing || (u.isAnimating && u.firstRun))) {
                        if (
                            ((t = parseInt(t, 10)),
                                (a = u.current ? u.current.opts.loop : u.opts.loop), !a && (t < 0 || t >= p))
                        )
                            return !1;
                        if (
                            ((i = u.firstRun = !Object.keys(u.slides).length), !(p < 2 && !i && u.isDragging))
                        ) {
                            if (
                                ((r = u.current),
                            ...
                            n.each(u.slides, function(t, e) {
                                ...
                                ((c = Math.round(s.$slide.width())),
                                    n.each(u.slides, function(t, o) {
                                        var i = o.pos - s.pos;
                                        n.fancybox.animate(
                                            o.$slide, { top: 0, left: i * c + i * o.opts.gutter },
                                            e,
                                            function() {
                                                o.$slide
                                                    .removeAttr("style")
                ...
                centerSlide: function(t, e) {
                    ...
                    s.current &&
                        ((i = Math.round(t.$slide.width())),
                            ...
                            n.fancybox.animate(
                                t.$slide, { top: 0, left: a * i + a * t.opts.gutter, opacity: 1 },
                                e === o ? 0 : e,
                                null, !1
                            ));
                },
                ...
                afterLoad: function(t) {
                    ...
                    e.isClosing ||
                        ((t.isLoading = !1),
                            ...
                            e.hideLoading(t),
                            t.pos === e.currPos && e.updateCursor(), !t.opts.smallBtn ||
                ...
                getThumbPos: function(o) {
                    var i,
                        ...
                        l = function(e) {
                            for (
                                var o, i = e[0], a = i.getBoundingClientRect(), s = []; null !== i.parentElement;
